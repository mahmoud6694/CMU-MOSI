...
def extract(root, dataset):
    dataset = dataset.upper()
    input_directory_path = f'{root}/data/{dataset}/Raw'
    output_directory_path = f'{root}/data/{dataset}/wav'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--root', type=str, default='kaggle/working', help='root directory of repo')
    ...
    extract(args.root, args.dataset)
